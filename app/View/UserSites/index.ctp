        ...
        <?php foreach ($userSites as $userSite): ?>
            <tr class="one-url" data-url="<?php echo $userSite['UserSite']['URLID']; ?>">
                ...
                <td class="actions">
                    ...
                    <form action="/larrybeth/linkcheck/UserSites/delete/<?php echo $userSite['UserSite']['UserSiteID']; ?>" name="post_<?php echo $userSite['UserSite']['UserSiteID']; ?>" id="post_<?php echo $userSite['UserSite']['UserSiteID']; ?>" style="display:none;" method="post">        
